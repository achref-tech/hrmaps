...
@Component({
  selector: 'app-employee-affecterclient',
  templateUrl: './employee-affecterclient.component.html',
  styleUrls: ['./employee-affecterclient.component.css']
})
export class EmployeeAffecterclientComponent implements OnInit {
